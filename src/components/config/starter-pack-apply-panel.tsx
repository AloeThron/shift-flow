  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-muted-foreground text-sm">
        การนำเข้าจะแทนที่การตั้งค่าองค์กร (พื้นที่ปฏิบัติงาน รหัสเวร กำลังคนขั้นต่ำ กติกา และพนักงานตัวอย่าง)
        แล้วสร้างตารางเวรเดือนตัวอย่างให้ดูที่หน้าเวร — ตารางเดิม / ร่างที่มีอยู่จะถูกล้าง
      </p>
